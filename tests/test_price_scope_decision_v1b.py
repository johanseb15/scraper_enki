...
def test_hourly_remote_query_uses_only_hourly_standard_cohort():
    ...
    r = resolver_consulta_pricing(
        "me quieren cobrar 35 lucas la hora por soporte remoto a todo el país en horario habitual, está bien?",
        local_cohortes=(),
...
def test_monthly_remote_query_does_not_use_hourly_evidence():
    ...
    r = resolver_consulta_pricing(
        "me quieren cobrar 35 lucas al mes por soporte remoto a todo el país en horario habitual, está bien?",
        local_cohortes=(),
        remote_cohortes=[hourly],
    )
