...
BUY=(r"\bme quieren cobrar\b",r"\bme cobran\b",r"\bme cobraron\b",r"\bme pasaron\b",r"\bme presupuestaron\b",r"\bme cotizaron\b",r"\bpagar\b",r"\bme ofrecieron\b")
SELL=(r"\bquiero cobrar\b",r"\bcuanto cobrar\b",r"\ble puedo cobrar\b",r"\bdeberia cobrar\b",r"\bcuanto pedir\b")
EVAL=(r"\besta bien\b",r"\bes mucho\b",r"\bes caro\b",r"\besta caro\b",r"\bes barato\b",r"\bme estan matando\b",r"\bme estan afanando\b",r"\bme quedo corto\b",r"\bme estoy pasando\b",r"\brazonable\b")
