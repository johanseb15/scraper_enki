...
def main() -> None:
    ...
    parser.add_argument(
        "--out",
        default="data/evaluation/offer_service_reach_admission_gate_v1.json",
    )
    parser.add_argument("--local-out", default="data/local_pricing_stats_reach_v1.csv")
    parser.add_argument("--remote-out", default="data/remote_pricing_stats_reach_v1.csv")
