...
def main() -> None:
    ...
    parser.add_argument(
        "--out",
        default="data/evaluation/temporal_evidence_admissibility_v1.json",
    )
    parser.add_argument("--temporal-out", default="data/temporal_evidence_v1.jsonl")
    parser.add_argument("--local-out", default="data/local_pricing_stats_temporal_v1.csv")
    parser.add_argument("--remote-out", default="data/remote_pricing_stats_temporal_v1.csv")
